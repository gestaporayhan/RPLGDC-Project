...
<div class="form-group">
  ...
  <div class="col-md-5">
    <input type="text" name="username" class="form-control" placeholder="Username pengguna" value="<?php echo set_value('username') ?>" required>
  </div>
</div>
...
<div class="form-group">
  ...
  <div class="col-md-5">
    <input type="password" name="password" class="form-control" placeholder="Password pengguna" value="<?php echo set_value('password') ?>" required>
  </div>
</div>
